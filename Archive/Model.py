...
ep = 40 #0, 200, 400, 800]#200
batch_size = 256 # turn off mini batch by removing X_train.shape[0]
learnrate = 0.001#, 0.0006, 0.0001, 0.00006, 0.00001, 0.000006, 0.000001, 0.0000006, 0.0000001]
l2 = 0.000001#, 0.0006, 0.0001, 0.00006, 0.00001, 0.000006, 0.000001, 0.0000006, 0.0000001]
conv_layer = 4
Drop = 0
count = 0
...
model = CNN()
#standard fit
history = model.fit(X_train, y_train, validation_split=0.2, batch_size=batch_size, epochs = ep, verbose=1)
